...
void main() => runApp(Inscription_tablette_desktop());



class Inscription_tablette_desktop extends StatefulWidget {
  @override
  _mainState createState() => _mainState();
}


class _mainState extends State<Inscription_tablette_desktop> {
  @override
